...
export default function ServerCard() {
  ...
  return sponsors.map(sponsor => (
    <div
      key={sponsor.name}
      className="flex flex-col md:flex-row justify-between text-white bg-gradient-to-b md:bg-gradient-to-r from-blueprint from-45% to-white space-y-6 md:space-y-0 to-85% md:-mx-20 rounded-[50px] p-6 md:pl-20 hover:shadow-[0px_4px_4px_0_rgba(0,0,0,0.25)] transition-shadow ease-in-out duration-300"
    >
