  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="group relative h-80 w-80 min-w-fit rounded-[35px] bg-gradient-to-t from-blueprint/70 from-25% to-blueprint/15 to-65% md:h-80 md:w-80 lg:h-72 lg:w-72">
        <span className="group:transition absolute inset-x-0 bottom-0 translate-y-10 px-6 pb-10 text-center text-white duration-300 ease-in-out group-hover:translate-y-0">
