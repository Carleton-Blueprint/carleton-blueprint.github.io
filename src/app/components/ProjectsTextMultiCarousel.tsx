...
export default function ProjectsTextMultiCarousel() {
  return <div>ProjectsTextMultiCarousel</div>;
}
...
//           <ProjectCard key={uuidv4()} props={project} />
//         ))}
//       </MobileProjects>
...
//             <SplideArrow className={`splide__arrow splide__arrow--prev removal-${arrowRemoval}`} icon={icon({ name: "chevron-left" })} color="#3988ff" />
//             <SplideArrow className={`splide__arrow splide__arrow--next removal-${arrowRemoval}`} icon={icon({ name: "chevron-right" })} color="#3988ff" />
//           </div>
//         </CustomSplide>
//       )}
//     </>
...
//     // Needs to be a manual number, if not nothing renders at 768px
//     display: none;
//   }
// `;
